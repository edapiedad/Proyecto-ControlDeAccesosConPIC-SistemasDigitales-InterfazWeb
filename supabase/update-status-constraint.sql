...
-- 2. Crear la nueva restricción con TODOS los estados del PIC + eventos de conectividad ESP32
ALTER TABLE public.access_logs ADD CONSTRAINT access_logs_status_check 
  CHECK (status IN (
    ...
    'WIFI_ON',        -- ESP32 reconectado a la red WiFi
    'WIFI_OFF'        -- ESP32 perdió la conexión WiFi
  ));
